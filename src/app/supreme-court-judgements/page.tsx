...
export default function SupremeCourtJudgementsPage() {
  ...
  const fetchArticles = async (reset = true) => {
    try {
      ...
      const data = await fetchWithLoading<{articles: Article[]}>(
        ...
        {},
        {
          message: reset ? 'Loading Supreme Court judgements...' : 'Loading more judgements...',
          showProgress: false
        }
      );
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Supreme Court
            <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> Judgements</span>
          </h1>
          
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
            Explore landmark Supreme Court decisions, constitutional interpretations, and legal precedents that shape Indian jurisprudence.
          </p>
          ...
          <form onSubmit={handleSearch} className="max-w-3xl mx-auto mb-8">
            <div className="relative group">
              ...
              <div className="relative bg-white/15 backdrop-blur-md rounded-3xl border border-white/20 shadow-2xl" style={{ zIndex: 25 }}>
                <div className="flex items-center relative" style={{ zIndex: 30 }}>
                  ...
                  <input
                    type="text"
                    placeholder="Search Supreme Court judgements, cases, or legal topics..."
                    value={searchTerm}
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-2">
              {['Constitutional Law', 'Fundamental Rights', 'Criminal Law', 'Civil Rights', 'Landmark Cases'].map((suggestion) => (
                <button
                  key={suggestion}
      ...
      {/* Supreme Court Judgements Section */}
      <section className="relative py-16 px-4 sm:px-6 lg:px-8 bg-white/95 backdrop-blur-sm z-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Supreme Court Judgements</h2>
            <p className="text-lg text-gray-600">Landmark decisions and constitutional interpretations from India&apos;s highest court</p>
          </div>
          ...
          {loading ? (
            ...
            <Card className="text-center py-16">
              <CardContent>
                <Landmark className="h-16 w-16 mx-auto text-gray-400 mb-4" />
                <h3 className="text-xl font-semibold text-gray-900 mb-2">No Supreme Court judgements found</h3>
                <p className="text-gray-600 mb-6">
                  {searchTerm ? 'Try adjusting your search terms' : 'No Supreme Court judgements available yet'}
                </p>
                {searchTerm && (
                  <Button onClick={() => {
                    setSearchTerm('');
              ...
              {articles.map((article) => (
                <Card key={article.id} className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  {article.featuredImage ? (
                    ...
                    <div className="relative h-48 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-600 flex items-center justify-center">
      ...
      <NewsletterCTA
        title="Stay Updated with Supreme Court Decisions"
        description="Get the latest Supreme Court judgements, constitutional interpretations, and legal analysis delivered to your inbox."
        gradient="from-blue-600 to-purple-600"
        textColor="text-blue-100"
        buttonColor="text-blue-600"
        variant="premium"
        badgeText="Supreme Court Updates"
      />
