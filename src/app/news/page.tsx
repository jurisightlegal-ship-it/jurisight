                  ...
                  {article.featuredImage ? (
                    <div className="relative h-48 overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4 flex gap-2">
                        ...
                        {article.isTopNews && (
                          <Badge className="text-xs px-3 py-1 backdrop-blur-sm bg-yellow-500/90 text-yellow-900 border-yellow-400 font-semibold">
                            ⭐ Top News
                          </Badge>
                        )}
                      </div>
                    ...
                    <div className="relative h-48 bg-gradient-to-br from-orange-600 via-red-600 to-pink-600 flex items-center justify-center">
